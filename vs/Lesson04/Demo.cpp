...
void Demo::BuildColoredTiang() {
	...
	float vertices1[] = {
		...
		//TIANG 2
		// front
	    -0.5, -0.5, -5.5, 0, 0,  // 24 ,,kiba,
		0.5, -0.5, -5.5, 1, 0,  // 25 ,,kaba,
		0.5,  4.0, -5.5, 1, 1,  // 26 ,,kaat,
		-0.5,  4.0, -5.5, 0, 1,  // 27 ,,kiat
		// right
		0.5,  4.0, -5.5, 0, 0,  // 28
		0.5,  4.0, -4.5, 1, 0,  // 29
		0.5, -0.5, -4.5, 1, 1,  // 30
		...
		//TIANG 3
		// front
		-0.5, -0.5, -10.0, 0, 0,  // 48 ,,kiba,
		0.5, -0.5, -10.0, 1, 0,  // 49 ,,kaba,
		0.5,  4.0, -10.0, 1, 1,  // 50 ,,kaat,
		-0.5,  4.0, -10.0, 0, 1,  // 51 ,,kiat
		// right
		0.5,  4.0,  -10.0, 0, 0,  // 52
		0.5,  4.0, -9.0, 1, 0,  // 53
		0.5, -0.5, -9.0, 1, 1,  // 54
		...
		//TIANG 4
		// front
		-0.5, -0.5, -14.5, 0, 0,  // 72 ,,kiba,
		0.5, -0.5, -14.5, 1, 0,  // 73 ,,kaba,
		0.5,  4.0, -14.5, 1, 1,  // 74 ,,kaat,
		-0.5,  4.0, -14.5, 0, 1,  // 75 ,,kiat
		// right
		0.5,  4.0,  -14.5, 0, 0,  // 76
		0.5,  4.0, -13.5, 1, 0,  // 77
		0.5, -0.5, -13.5, 1, 1,  // 78
		...
		//TIANG 5
		// front
		-0.5, -0.5, -19.0, 0, 0,  // 96 ,,kiba,
		0.5, -0.5, -19.0, 1, 0,  // 97 ,,kaba,
		0.5,  4.0, -19.0, 1, 1,  // 98 ,,kaat,
		-0.5,  4.0, -19.0, 0, 1,  // 99 ,,kiat
		// right
		0.5,  4.0, -19.0, 0, 0,  // 100
		0.5,  4.0, -18.0, 1, 0,  // 101
		0.5, -0.5, -18.0, 1, 1,  // 102
		0.5, -0.5, -19.0, 0, 1,  // 103
		// back
		-0.5, -0.5, -18.0, 0, 0, // 104
		0.5, -0.5, -18.0, 1, 0, // 105
		0.5,  4.0, -18.0, 1, 1, // 106
		-0.5,  4.0, -18.0, 0, 1, // 107
		// left
		-0.5, -0.5, -18.0, 0, 0, // 108
		-0.5, -0.5, -19.0, 1, 0, // 109
		-0.5,  3.0, -19.0, 1, 1, // 110
		-0.5,  3.0, -18.0, 0, 1, // 111
		// upper
		0.5, 4.0,  -19.0, 0, 0,   // 112
		-0.5, 4.0, -19.0, 1, 0,  // 113
		-0.5, 4.0, -18.0, 1, 1,  // 114
		0.5, 4.0, -18.0, 0, 1,   // 115
		// bottom
		-0.5, -0.5, -18.0, 0, 0, // 116
		0.5, -0.5, -18.0, 1, 0,  // 117
		0.5, -0.5,  -19.0, 1, 1,  // 118
		-0.5, -0.5,  -19.0, 0, 1, // 119
	};
...
void Demo::BuildColoredPlane()
{
	...
	int width, height;
	unsigned char* image = SOIL_load_image("download.jpg", &width, &height, 0, SOIL_LOAD_RGBA);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, image);
	glGenerateMipmap(GL_TEXTURE_2D);
	SOIL_free_image_data(image);
	glBindTexture(GL_TEXTURE_2D, 0);
